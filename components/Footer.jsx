...
/**
 * @component Footer
 * @description A responsive footer component for the FluxStore application.
 * It includes social media links, copyright information, and navigation links.
        ...
        <div className="py-8 md:flex md:items-center md:justify-between">
          ...
          <div className="mt-8 md:mt-0 md:order-1">
            <p className="text-center text-base">
              &copy; 2024 FluxStore, Inc. All rights reserved.
            </p>
          </div>
        </div>
        {/* Footer navigation */}
        <div className="py-4 border-t border-teal-600 md:flex md:items-center md:justify-between">
